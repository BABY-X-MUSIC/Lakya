...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("LevyMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("LevyMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("LevyMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("LevyMusic/assets/play_icons.png")
