...
async def style_buttons(c, m, cb=False):
    ...
    buttons = [
        ...
        [InlineKeyboardButton ("Close",callback_data="close_reply"),InlineKeyboardButton ("Next ➻", callback_data="nxt")],
    ]
    if not cb:
        await m.reply_text(
...
async def nxt(c, m):
    if m.data == "nxt":
        buttons = [
            ...
            [InlineKeyboardButton ("Close",callback_data="close_reply"),InlineKeyboardButton ("Back", callback_data="nxt+0")],
        ]
        await m.answer()
        await m.message.edit_reply_markup(InlineKeyboardMarkup(buttons))
    else:
...
__help__ = """
 ...
 ❍ /fonts <text> *:* Converts simple text to beautifull nxt by changing it's font.
 """
