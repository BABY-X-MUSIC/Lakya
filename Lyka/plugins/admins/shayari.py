...
async def mentionall(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("Your are not admin baby, Only admins can. ")

    if message.reply_to_message and message.text:
        return await message.reply("/shayaril  Type like this / Reply any msg next time")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        if not msg:
            return await message.reply("/shayari  Type like this / Reply any msg next time...")
    else:
        return await message.reply("/shayari  Type like this / Reply any msg next time..")
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("♦ Process stopped succesfully ♦")
